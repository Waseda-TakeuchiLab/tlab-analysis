...
class WavelengthResolved(t.Generic[DT]):
    ...
    def _determine_fitting_range(self) -> tuple[float, float]:  # pragma: no cover
        ...
        right = df["time"][
            ...
            & (df["intensity"] >= alpha * df["intensity"].max())
        ].max()
